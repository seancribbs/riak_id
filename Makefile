...
stage : rel
	$(foreach dep,$(wildcard deps/* wildcard apps/*), rm -rf rel/riak_id/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/riak_id/lib;)
...
COMBO_PLT = $(HOME)/.riak_id_combo_dialyzer_plt
